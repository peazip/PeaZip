Name: peazip
Summary: PeaZip file manager and archiver (GTK2)
Version: 8.3.0.LINUX.GTK2
Release: 1
License: LGPLv3
...
%description
PeaZip is a cross-platform portable file and archive manager, released under LGPLv3.
