...
LicenseFile=C:\input\peazip-8.1.0.WIN64\copying.txt
OutputDir=C:\output\
OutputBaseFilename=peazip-8.1.0.WIN64
...
[Files]
Source: "C:\input\peazip-8.1.0.WIN64\peazip.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-8.1.0.WIN64\dragdropfilesdll.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-8.1.0.WIN64\res\*"; DestDir: "{app}\res"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\input\peazip-8.1.0.WIN64\SendTo.pea"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-8.1.0.WIN64\copying.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-8.1.0.WIN64\readme_Win64.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-8.1.0.WIN64\peazip_help.pdf"; DestDir: "{app}"; Flags: ignoreversion
