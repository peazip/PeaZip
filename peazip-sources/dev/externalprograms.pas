...
const
  APPLICATION_PEA = 'Pea 1.33 (LGPLv3, Giorgio Tani)';

  {$IFDEF MSWINDOWS}
  EXEEXT        = '.exe';
  UNRARNAME     = 'unrar';
  APPLICATION_7Z = '7z 26.03 (LGPL, Igor Pavlov), and Tino Reichardt sfx modules and codecs 24.09-v1.5.7-R1 (LGPL)';
  {$IFDEF WIN64}
  ...
  APPLICATION_7Z   = 'Linux 7z 26.03 (LGPL, Igor Pavlov), Tino Reichardt 7-Zip ZS 25.01-v1.5.7-R4 (LGPL)';
  APPLICATION_ZSTD = 'Zstd 1.5.7 (Dual license BSD / GPLv2, Yann Collet, Przemysław Skibiński)';
  {$IFDEF CPUAARCH64}
  APPLICATION_ZPAQ    = '';
  ...
  EXEEXT        = '';
  UNRARNAME     = '';
  APPLICATION_7Z      = 'macOS 7z 26.03 (LGPL, Igor Pavlov), cielavenir/p7zip 24.09.1 (LGPL, T. Yamada)';
  ...
  //Pea 1.33
  HPEA_BSD_X_GTK2     = '062AA53EAB7CDB06E1AE505377D2F59C9B5281FF33AC6784C1984ADE828C9475'; //BSD x86_64 GTK2
  HPEA_LIN_A_GTK2     = '147F91602B02D2CE8FEF920861F40037F2B24214F9D2AEE3985BD4C19179C5BB'; //lin aarch64 GTK2
  HPEA_LIN_X_GTK2     = '7BA903E28C08A61CF76E9CB6CF5F2EB2C60ED05B539E41A8942D4204DA20C8B9'; //lin x86_64 GTK2
  HPEA_LIN_X_GTK3     = '056B55CA8F36FD3710787CAA1D86893107A92B65D6D9EEC01F10FACC254A730E'; //lin x86_64 GTK3
  HPEA_LIN_X_QT6      = 'EEF2D5656096C0AEC072C09A80719F239A07D3CD9FB3534D8DA7BA6849822430'; //lin x86_64 Qt6
  HPEA_MACOS_A        = 'B68CFBF7F4CDA1C00D75E26EBFE1E0A247185C4B36D0297E5A1F271960D1C2FF'; //macos aarch64
  HPEA_MACOS_X        = 'C303115F80F24932D9C4686598783CF239F3C2DF71386A990B26E6548B6B635E'; //macos Intel x86_64
  HPEA_WIN32_X        = 'EA0EF84C3CB7050B07F49C11A5A0E935657E0CE4E5095EEF0D3812C18D6EA14C'; //win32
  HPEA_WIN64_X        = '5D0E7BC3AE42D681921D3DE6D1E21A384750238DD21585A2C368E187BBB602D4'; //win64
  ...
  //7z 26.03
  H7Z_WIN64_X         = '6EE3C0ED0B27663C1B948AE85A7C0BB073AED1498983182F3F0DF1F6A8C30B2F'; //7z\7z win64
  H7ZDLL_WIN64_X      = '65E4C1F855F9EF6E8F0F5DF8E3F27D9EB5F07311408639DA0A1CA0B8F4871B0D'; //7z\7z.dll win64
  H7Z_WIN32_X         = 'CD74719140D12A6C837A6F78257DF326F79B1A6FFCD632E9A2048E278899B733'; //7z\7z win32
  H7ZDLL_WIN32_X      = 'D132E89038C802C5D5281E543A83DC407680EFFE0144F21B4FB431DD45FCA61D'; //7z\7z.dll win32
  H7Z_LIN_A           = '277907BC627633EC344757FE47699856CBB6E37F75CBC310D37D62CFACDD73B2'; //7z\7z aarch64
  H7Z_LIN_X           = 'EAB4C8D7F193E3D6D3237370BBCAA879A160A3F1DC82202207E27BAEAB79B6AC'; //7z\7z linux x86_64
  H7Z_MACOS           = '74B0910E50EA44D9760A57FADA2192CFD530BA8BFFBE7B47C412A464B796CABF'; //7z\7z macOS universal binary
