...
AppName=PeaZip
AppVerName=PeaZip 11.3.0 (WIN64)
AppVersion=11.3.0
...
LicenseFile=C:\input\peazip-11.3.0.WIN64\res\share\copying\copying.txt
OutputDir=C:\output\
OutputBaseFilename=peazip-11.3.0.WIN64
...
[Files]
Source: "C:\input\peazip-11.3.0.WIN64\peazip.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-11.3.0.WIN64\pea.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-11.3.0.WIN64\dragdropfilesdll.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-11.3.0.WIN64\res\*"; DestDir: "{app}\res"; Flags: ignoreversion recursesubdirs createallsubdirs
