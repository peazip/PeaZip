...
LicenseFile=C:\input\peazip-9.9.0.WINDOWS\res\share\copying\copying.txt
OutputDir=C:\output\
OutputBaseFilename=peazip-9.9.0.WINDOWS
...
[Files]
Source: "C:\input\peazip-9.9.0.WINDOWS\peazip.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-9.9.0.WINDOWS\pea.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-9.9.0.WINDOWS\dragdropfilesdll.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-9.9.0.WINDOWS\res\*"; DestDir: "{app}\res"; Flags: ignoreversion recursesubdirs createallsubdirs
