...
DEB folder contains DEB package folders for Linux GTK2 and Qt5 builds.

RPM folder contains RPM folders and specs folder for Linux GTK2 and Qt5 builds.

To edit BDS packages, which are portable, simply extract the package as a plain archive file and edit the content referring to .src package's readme instructions.
